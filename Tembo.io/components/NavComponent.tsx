...
export default function NavComponent() {
  ...
  return (
    <div className="sticky top-0 z-10 navv bg-black text-xl font-bold drop-shadow-xl flex-none transition-colors duration-500  ">
      <style jsx>
        {`
          .navv {
            ...
            <div className="-mr-2 -my-2 sm:hidden">
              <>
                {isModalOpen ? (
                  ...
                  >
                    <div className="rounded-lg shadow-lg  ring-1 h-full ring-black ring-opacity-5  bg-[#060707] border-[1px] border-red-100/20 text-white divide-y-2 divide-gray-50">
